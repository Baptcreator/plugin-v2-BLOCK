                ...
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="unit_per_person" name="unit_per_person" 
                                   value="<?php echo $product ? esc_attr($product['unit_per_person']) : ''; ?>" 
                                   class="regular-text" required placeholder="Ex: 150g/pers ou 3 pièces/pers">
                            <p class="description"><?php _e('Indiquez la quantité en grammes ou en pièces par personne.', 'restaurant-booking'); ?></p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description"><?php _e('Prix pour la quantité indiquée ci-dessus.', 'restaurant-booking'); ?></p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description"><?php _e('Unité de vente du plat.', 'restaurant-booking'); ?></p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description"><?php _e('Ex: Cornichons supplémentaires, Verrine végétarienne...', 'restaurant-booking'); ?></p>
                        </td>
                    </tr>
                    ...
                    <tr id="supplement_details" style="<?php echo (!$product || !$product['has_supplement']) ? 'display: none;' : ''; ?>">
                        ...
                        <td>
                            <input type="text" id="supplement_name" name="supplement_name" 
                                   ...
                                   class="regular-text" placeholder="<?php _e('Ex: Cornichons supplémentaires', 'restaurant-booking'); ?>">
                            <br><br>
                            ...
                            <p class="description">
                                <?php _e('⚠️ Important: La quantité de suppléments ne peut pas dépasser la quantité du plat principal commandé.', 'restaurant-booking'); ?>
                            </p>
                        </td>
                    </tr>
